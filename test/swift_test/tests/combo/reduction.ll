...
; <label>:81:                                     ; preds = %113, %54
  ...
  br i1 %94, label %114, label %96, !dbg !168
...
; <label>:97:                                     ; preds = %96
  ...
  %99 = load i64, i64* %a._value80, align 8, !dbg !171
  %100 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %99, i64 1), !dbg !173
  %101 = extractvalue { i64, i1 } %100, 0, !dbg !173
  %102 = extractvalue { i64, i1 } %100, 1, !dbg !173
  br i1 %102, label %370, label %103, !dbg !173

; <label>:103:                                    ; preds = %97
  %a._value81 = getelementptr inbounds %TSi, %TSi* %a, i32 0, i32 0, !dbg !174
  store i64 %101, i64* %a._value81, align 8, !dbg !174
  %b._value82 = getelementptr inbounds %TSi, %TSi* %b, i32 0, i32 0, !dbg !175
  %104 = load i64, i64* %b._value82, align 8, !dbg !175
  %105 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %104, i64 5), !dbg !176
  %106 = extractvalue { i64, i1 } %105, 0, !dbg !176
  %107 = extractvalue { i64, i1 } %105, 1, !dbg !176
  br i1 %107, label %371, label %108, !dbg !176

; <label>:108:                                    ; preds = %103
  %b._value83 = getelementptr inbounds %TSi, %TSi* %b, i32 0, i32 0, !dbg !177
  store i64 %106, i64* %b._value83, align 8, !dbg !177
  %c._value84 = getelementptr inbounds %TSi, %TSi* %c, i32 0, i32 0, !dbg !178
  %109 = load i64, i64* %c._value84, align 8, !dbg !178
  %110 = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %109, i64 2), !dbg !179
  %111 = extractvalue { i64, i1 } %110, 0, !dbg !179
  %112 = extractvalue { i64, i1 } %110, 1, !dbg !179
  br i1 %112, label %372, label %113, !dbg !179

; <label>:113:                                    ; preds = %108
  %c._value85 = getelementptr inbounds %TSi, %TSi* %c, i32 0, i32 0, !dbg !180
  store i64 %111, i64* %c._value85, align 8, !dbg !180
  br label %81, !dbg !181

; <label>:114:                                    ; preds = %81
  %115 = bitcast %Ts16IndexingIteratorVySNySiGG* %"$i$generator" to i8*, !dbg !156
  call void @llvm.lifetime.end.p0i8(i64 25, i8* %115), !dbg !156
  %116 = bitcast %Ts16IndexingIteratorVySNySiGG* %"$i$generator11" to i8*, !dbg !182
  call void @llvm.lifetime.start.p0i8(i64 25, i8* %116), !dbg !182
  %117 = bitcast %TSNySiG* %11 to i8*, !dbg !182
  call void @llvm.lifetime.start.p0i8(i64 16, i8* %117), !dbg !182
  %118 = bitcast [24 x i8]* %access-scratch12 to i8*, !dbg !184
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %118), !dbg !184
  ...
  %119 = load i64, i64* getelementptr inbounds (%TSi, %TSi* @"$s9reduction10iterationsSivp", i32 0, i32 0), align 8, !dbg !184
  call void @swift_endAccess([24 x i8]* %access-scratch12) #2, !dbg !184
  %120 = bitcast [24 x i8]* %access-scratch12 to i8*, !dbg !184
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %120), !dbg !184
  br label %121, !dbg !185

; <label>:121:                                    ; preds = %114
  %122 = icmp slt i64 %119, 0, !dbg !185
  %123 = xor i1 %122, true, !dbg !185
  %124 = call i1 @llvm.expect.i1(i1 %123, i1 true), !dbg !185
  br i1 %124, label %125, label %151, !dbg !185

; <label>:125:                                    ; preds = %121
  %126 = bitcast %TSi* %12 to i8*, !dbg !182
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %126), !dbg !182
  %._value13 = getelementptr inbounds %TSi, %TSi* %12, i32 0, i32 0, !dbg !185
  store i64 0, i64* %._value13, align 8, !dbg !185
  %127 = bitcast %TSi* %13 to i8*, !dbg !182
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %127), !dbg !182
  %._value14 = getelementptr inbounds %TSi, %TSi* %13, i32 0, i32 0, !dbg !185
  store i64 %119, i64* %._value14, align 8, !dbg !185
  %._value15 = getelementptr inbounds %TSi, %TSi* %12, i32 0, i32 0, !dbg !185
  %128 = load i64, i64* %._value15, align 8, !dbg !185
  %._value16 = getelementptr inbounds %TSi, %TSi* %13, i32 0, i32 0, !dbg !185
  %129 = load i64, i64* %._value16, align 8, !dbg !185
  %130 = call swiftcc { i64, i64 } @"$sSN15uncheckedBoundsSNyxGx5lower_x5uppert_tcfCSi_Tg5"(i64 %128, i64 %129), !dbg !185
  %131 = extractvalue { i64, i64 } %130, 0, !dbg !185
  %132 = extractvalue { i64, i64 } %130, 1, !dbg !185
  ...
  store i64 %131, i64* %.lowerBound17._value, align 8, !dbg !185
  ...
  store i64 %132, i64* %.upperBound18._value, align 8, !dbg !185
  %133 = bitcast %TSi* %13 to i8*, !dbg !185
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %133), !dbg !185
  %134 = bitcast %TSi* %12 to i8*, !dbg !185
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %134), !dbg !185
  ...
  %135 = load i64, i64* %.lowerBound19._value, align 8, !dbg !185
  ...
  %136 = load i64, i64* %.upperBound20._value, align 8, !dbg !185
  %137 = bitcast %TSNySiG* %14 to i8*, !dbg !182
  call void @llvm.lifetime.start.p0i8(i64 16, i8* %137), !dbg !182
  ...
  store i64 %135, i64* %.lowerBound21._value, align 8, !dbg !185
  ...
  store i64 %136, i64* %.upperBound22._value, align 8, !dbg !185
  ...
  %138 = load i64, i64* %.lowerBound23._value, align 8, !dbg !186
  ...
  %139 = load i64, i64* %.upperBound24._value, align 8, !dbg !186
  %140 = call swiftcc { i64, i64, i64, i8 } @"$sSlss16IndexingIteratorVyxG0B0RtzrlE04makeB0ACyFSNySiG_Tg5"(i64 %138, i64 %139), !dbg !186
  %141 = extractvalue { i64, i64, i64, i8 } %140, 0, !dbg !186
  %142 = extractvalue { i64, i64, i64, i8 } %140, 1, !dbg !186
  %143 = extractvalue { i64, i64, i64, i8 } %140, 2, !dbg !186
  %144 = extractvalue { i64, i64, i64, i8 } %140, 3, !dbg !186
  %145 = trunc i8 %144 to i1, !dbg !186
  ...
  store i64 %141, i64* %"$i$generator11._elements.lowerBound._value", align 8, !dbg !186
  ...
  store i64 %142, i64* %"$i$generator11._elements.upperBound._value", align 8, !dbg !186
  ...
  %146 = bitcast %TSNsSxRzSZ6StrideRpzrlE5IndexOySi_G* %"$i$generator11._position" to i64*, !dbg !186
  store i64 %143, i64* %146, align 8, !dbg !186
  %147 = getelementptr inbounds %TSNsSxRzSZ6StrideRpzrlE5IndexOySi_G, %TSNsSxRzSZ6StrideRpzrlE5IndexOySi_G* %"$i$generator11._position", i32 0, i32 1, !dbg !186
  %148 = bitcast [1 x i8]* %147 to i1*, !dbg !186
  store i1 %145, i1* %148, align 8, !dbg !186
  %149 = bitcast %TSNySiG* %14 to i8*, !dbg !187
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %149), !dbg !187
  %150 = bitcast %TSNySiG* %11 to i8*, !dbg !187
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %150), !dbg !187
...
; <label>:152:                                    ; preds = %205, %125
  %153 = bitcast %TSiSg* %15 to i8*, !dbg !182
  call void @llvm.lifetime.start.p0i8(i64 9, i8* %153), !dbg !182
  %154 = call swiftcc { i64, i8 } @"$ss16IndexingIteratorV4next7ElementQzSgyFSNySiG_Tg5"(%Ts16IndexingIteratorVySNySiGG* nocapture swiftself dereferenceable(25) %"$i$generator11"), !dbg !188
  %155 = extractvalue { i64, i8 } %154, 0, !dbg !188
  %156 = extractvalue { i64, i8 } %154, 1, !dbg !188
  %157 = trunc i8 %156 to i1, !dbg !188
  %158 = bitcast %TSiSg* %15 to i64*, !dbg !188
  store i64 %155, i64* %158, align 8, !dbg !188
  %159 = getelementptr inbounds %TSiSg, %TSiSg* %15, i32 0, i32 1, !dbg !188
  %160 = bitcast [1 x i8]* %159 to i1*, !dbg !188
  store i1 %157, i1* %160, align 8, !dbg !188
  %161 = bitcast %TSiSg* %15 to i64*, !dbg !188
  %162 = load i64, i64* %161, align 8, !dbg !188
  %163 = getelementptr inbounds %TSiSg, %TSiSg* %15, i32 0, i32 1, !dbg !188
  %164 = bitcast [1 x i8]* %163 to i1*, !dbg !188
  %165 = load i1, i1* %164, align 8, !dbg !188
  %166 = bitcast %TSiSg* %15 to i8*, !dbg !187
  call void @llvm.lifetime.end.p0i8(i64 9, i8* %166), !dbg !187
  br i1 %165, label %206, label %167, !dbg !187

; <label>:167:                                    ; preds = %152
  br label %168, !dbg !187

; <label>:168:                                    ; preds = %167
  %169 = phi i64 [ %162, %167 ], !dbg !182
  store i64 %169, i64* %i.debug68, align 8, !dbg !189
  %170 = bitcast [24 x i8]* %access-scratch69 to i8*, !dbg !190
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %170), !dbg !190
  call void @swift_beginAccess(i8* bitcast (%TSi* @"$s9reduction2bGSivp" to i8*), [24 x i8]* %access-scratch69, i64 32, i8* null) #2, !dbg !190
  %171 = load i64, i64* getelementptr inbounds (%TSi, %TSi* @"$s9reduction2bGSivp", i32 0, i32 0), align 8, !dbg !190
  call void @swift_endAccess([24 x i8]* %access-scratch69) #2, !dbg !190
  %172 = bitcast [24 x i8]* %access-scratch69 to i8*, !dbg !190
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %172), !dbg !190
  %173 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %171, i64 5), !dbg !192
  %174 = extractvalue { i64, i1 } %173, 0, !dbg !192
  %175 = extractvalue { i64, i1 } %173, 1, !dbg !192
  br i1 %175, label %365, label %176, !dbg !192

; <label>:176:                                    ; preds = %168
  %177 = bitcast [24 x i8]* %access-scratch70 to i8*, !dbg !193
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %177), !dbg !193
  call void @swift_beginAccess(i8* bitcast (%TSi* @"$s9reduction2bGSivp" to i8*), [24 x i8]* %access-scratch70, i64 33, i8* null) #2, !dbg !193
  store i64 %174, i64* getelementptr inbounds (%TSi, %TSi* @"$s9reduction2bGSivp", i32 0, i32 0), align 8, !dbg !193
  call void @swift_endAccess([24 x i8]* %access-scratch70) #2, !dbg !193
  %178 = bitcast [24 x i8]* %access-scratch70 to i8*, !dbg !193
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %178), !dbg !193
  %c._value71 = getelementptr inbounds %TSi, %TSi* %c, i32 0, i32 0, !dbg !194
  %179 = load i64, i64* %c._value71, align 8, !dbg !194
  %180 = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %179, i64 %169), !dbg !195
  %181 = extractvalue { i64, i1 } %180, 0, !dbg !195
  %182 = extractvalue { i64, i1 } %180, 1, !dbg !195
  br i1 %182, label %366, label %183, !dbg !195

; <label>:183:                                    ; preds = %176
  %c._value72 = getelementptr inbounds %TSi, %TSi* %c, i32 0, i32 0, !dbg !196
  store i64 %181, i64* %c._value72, align 8, !dbg !196
  %184 = bitcast %TSi* %35 to i8*, !dbg !197
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %184), !dbg !197
  %185 = call swiftcc i64 @"$sSayxSicigSi_Tg5"(i64 %169, %Ts28__ContiguousArrayStorageBaseC* %44), !dbg !199
  %._value73 = getelementptr inbounds %TSi, %TSi* %35, i32 0, i32 0, !dbg !199
  store i64 %185, i64* %._value73, align 8, !dbg !199
  %._value74 = getelementptr inbounds %TSi, %TSi* %35, i32 0, i32 0, !dbg !199
  %186 = load i64, i64* %._value74, align 8, !dbg !199
  %187 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %186, i64 3), !dbg !200
  %188 = extractvalue { i64, i1 } %187, 0, !dbg !200
  %189 = extractvalue { i64, i1 } %187, 1, !dbg !200
  br i1 %189, label %367, label %190, !dbg !200

; <label>:190:                                    ; preds = %183
  %191 = bitcast %TSi* %35 to i8*, !dbg !200
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %191), !dbg !200
  %192 = bitcast [24 x i8]* %access-scratch75 to i8*, !dbg !201
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %192), !dbg !201
  ...
  %193 = load i64, i64* getelementptr inbounds (%TSi, %TSi* @"$s9reduction8localResSivp", i32 0, i32 0), align 8, !dbg !201
  call void @swift_endAccess([24 x i8]* %access-scratch75) #2, !dbg !201
  %194 = bitcast [24 x i8]* %access-scratch75 to i8*, !dbg !201
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %194), !dbg !201
  %195 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %188, i64 %193), !dbg !202
  %196 = extractvalue { i64, i1 } %195, 0, !dbg !202
  %197 = extractvalue { i64, i1 } %195, 1, !dbg !202
  br i1 %197, label %368, label %198, !dbg !202

; <label>:198:                                    ; preds = %190
  %199 = bitcast [24 x i8]* %access-scratch76 to i8*, !dbg !203
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %199), !dbg !203
  ...
  store i64 %196, i64* getelementptr inbounds (%TSi, %TSi* @"$s9reduction8localResSivp", i32 0, i32 0), align 8, !dbg !203
  call void @swift_endAccess([24 x i8]* %access-scratch76) #2, !dbg !203
  %200 = bitcast [24 x i8]* %access-scratch76 to i8*, !dbg !203
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %200), !dbg !203
  %a._value77 = getelementptr inbounds %TSi, %TSi* %a, i32 0, i32 0, !dbg !204
  %201 = load i64, i64* %a._value77, align 8, !dbg !204
  call void asm sideeffect "", "r"(i64 %201), !dbg !197
  call void @llvm.dbg.value(metadata i64 %201, metadata !205, metadata !DIExpression()), !dbg !206
  %202 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %201, i64 %169), !dbg !207
  %203 = extractvalue { i64, i1 } %202, 0, !dbg !207
  %204 = extractvalue { i64, i1 } %202, 1, !dbg !207
  br i1 %204, label %369, label %205, !dbg !207

; <label>:205:                                    ; preds = %198
  call void @llvm.dbg.value(metadata i64 %201, metadata !205, metadata !DIExpression()), !dbg !206
  %a._value78 = getelementptr inbounds %TSi, %TSi* %a, i32 0, i32 0, !dbg !208
  store i64 %203, i64* %a._value78, align 8, !dbg !208
  call void asm sideeffect "", "r"(i64 %201), !dbg !209
  br label %152, !dbg !209

; <label>:206:                                    ; preds = %152
  %207 = bitcast %Ts16IndexingIteratorVySNySiGG* %"$i$generator11" to i8*, !dbg !156
  call void @llvm.lifetime.end.p0i8(i64 25, i8* %207), !dbg !156
  %208 = bitcast %TSi* %arrSum to i8*, !dbg !156
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %208), !dbg !156
  %arrSum._value = getelementptr inbounds %TSi, %TSi* %arrSum, i32 0, i32 0, !dbg !210
  store i64 0, i64* %arrSum._value, align 8, !dbg !210
  %209 = bitcast %TSi* %arrMul to i8*, !dbg !156
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %209), !dbg !156
  %arrMul._value = getelementptr inbounds %TSi, %TSi* %arrMul, i32 0, i32 0, !dbg !211
  store i64 0, i64* %arrMul._value, align 8, !dbg !211
  %210 = bitcast %Ts16IndexingIteratorVySNySiGG* %"$i$generator25" to i8*, !dbg !212
  call void @llvm.lifetime.start.p0i8(i64 25, i8* %210), !dbg !212
  %211 = bitcast %TSNySiG* %19 to i8*, !dbg !212
  call void @llvm.lifetime.start.p0i8(i64 16, i8* %211), !dbg !212
  %212 = bitcast [24 x i8]* %access-scratch26 to i8*, !dbg !214
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %212), !dbg !214
  ...
  %213 = load i64, i64* getelementptr inbounds (%TSi, %TSi* @"$s9reduction10iterationsSivp", i32 0, i32 0), align 8, !dbg !214
  call void @swift_endAccess([24 x i8]* %access-scratch26) #2, !dbg !214
  %214 = bitcast [24 x i8]* %access-scratch26 to i8*, !dbg !214
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %214), !dbg !214
  br label %215, !dbg !215

; <label>:215:                                    ; preds = %206
  %216 = icmp slt i64 %213, 0, !dbg !215
  %217 = xor i1 %216, true, !dbg !215
  %218 = call i1 @llvm.expect.i1(i1 %217, i1 true), !dbg !215
  br i1 %218, label %219, label %245, !dbg !215

; <label>:219:                                    ; preds = %215
  %220 = bitcast %TSi* %20 to i8*, !dbg !212
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %220), !dbg !212
  %._value27 = getelementptr inbounds %TSi, %TSi* %20, i32 0, i32 0, !dbg !215
  store i64 0, i64* %._value27, align 8, !dbg !215
  %221 = bitcast %TSi* %21 to i8*, !dbg !212
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %221), !dbg !212
  %._value28 = getelementptr inbounds %TSi, %TSi* %21, i32 0, i32 0, !dbg !215
  store i64 %213, i64* %._value28, align 8, !dbg !215
  %._value29 = getelementptr inbounds %TSi, %TSi* %20, i32 0, i32 0, !dbg !215
  %222 = load i64, i64* %._value29, align 8, !dbg !215
  %._value30 = getelementptr inbounds %TSi, %TSi* %21, i32 0, i32 0, !dbg !215
  %223 = load i64, i64* %._value30, align 8, !dbg !215
  %224 = call swiftcc { i64, i64 } @"$sSN15uncheckedBoundsSNyxGx5lower_x5uppert_tcfCSi_Tg5"(i64 %222, i64 %223), !dbg !215
  %225 = extractvalue { i64, i64 } %224, 0, !dbg !215
  %226 = extractvalue { i64, i64 } %224, 1, !dbg !215
  ...
  store i64 %225, i64* %.lowerBound31._value, align 8, !dbg !215
  ...
  store i64 %226, i64* %.upperBound32._value, align 8, !dbg !215
  %227 = bitcast %TSi* %21 to i8*, !dbg !215
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %227), !dbg !215
  %228 = bitcast %TSi* %20 to i8*, !dbg !215
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %228), !dbg !215
  ...
  %229 = load i64, i64* %.lowerBound33._value, align 8, !dbg !215
  ...
  %230 = load i64, i64* %.upperBound34._value, align 8, !dbg !215
  %231 = bitcast %TSNySiG* %22 to i8*, !dbg !212
  call void @llvm.lifetime.start.p0i8(i64 16, i8* %231), !dbg !212
  ...
  store i64 %229, i64* %.lowerBound35._value, align 8, !dbg !215
  ...
  store i64 %230, i64* %.upperBound36._value, align 8, !dbg !215
  ...
  %232 = load i64, i64* %.lowerBound37._value, align 8, !dbg !216
  ...
  %233 = load i64, i64* %.upperBound38._value, align 8, !dbg !216
  %234 = call swiftcc { i64, i64, i64, i8 } @"$sSlss16IndexingIteratorVyxG0B0RtzrlE04makeB0ACyFSNySiG_Tg5"(i64 %232, i64 %233), !dbg !216
  %235 = extractvalue { i64, i64, i64, i8 } %234, 0, !dbg !216
  %236 = extractvalue { i64, i64, i64, i8 } %234, 1, !dbg !216
  %237 = extractvalue { i64, i64, i64, i8 } %234, 2, !dbg !216
  %238 = extractvalue { i64, i64, i64, i8 } %234, 3, !dbg !216
  %239 = trunc i8 %238 to i1, !dbg !216
  ...
  store i64 %235, i64* %"$i$generator25._elements.lowerBound._value", align 8, !dbg !216
  ...
  store i64 %236, i64* %"$i$generator25._elements.upperBound._value", align 8, !dbg !216
  ...
  %240 = bitcast %TSNsSxRzSZ6StrideRpzrlE5IndexOySi_G* %"$i$generator25._position" to i64*, !dbg !216
  store i64 %237, i64* %240, align 8, !dbg !216
  %241 = getelementptr inbounds %TSNsSxRzSZ6StrideRpzrlE5IndexOySi_G, %TSNsSxRzSZ6StrideRpzrlE5IndexOySi_G* %"$i$generator25._position", i32 0, i32 1, !dbg !216
  %242 = bitcast [1 x i8]* %241 to i1*, !dbg !216
  store i1 %239, i1* %242, align 8, !dbg !216
  %243 = bitcast %TSNySiG* %22 to i8*, !dbg !217
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %243), !dbg !217
  %244 = bitcast %TSNySiG* %19 to i8*, !dbg !217
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %244), !dbg !217
  br label %246, !dbg !217
...
; <label>:246:                                    ; preds = %283, %219
  %247 = bitcast %TSiSg* %23 to i8*, !dbg !212
  call void @llvm.lifetime.start.p0i8(i64 9, i8* %247), !dbg !212
  %248 = call swiftcc { i64, i8 } @"$ss16IndexingIteratorV4next7ElementQzSgyFSNySiG_Tg5"(%Ts16IndexingIteratorVySNySiGG* nocapture swiftself dereferenceable(25) %"$i$generator25"), !dbg !218
  %249 = extractvalue { i64, i8 } %248, 0, !dbg !218
  %250 = extractvalue { i64, i8 } %248, 1, !dbg !218
  %251 = trunc i8 %250 to i1, !dbg !218
  %252 = bitcast %TSiSg* %23 to i64*, !dbg !218
  store i64 %249, i64* %252, align 8, !dbg !218
  %253 = getelementptr inbounds %TSiSg, %TSiSg* %23, i32 0, i32 1, !dbg !218
  %254 = bitcast [1 x i8]* %253 to i1*, !dbg !218
  store i1 %251, i1* %254, align 8, !dbg !218
  %255 = bitcast %TSiSg* %23 to i64*, !dbg !218
  %256 = load i64, i64* %255, align 8, !dbg !218
  %257 = getelementptr inbounds %TSiSg, %TSiSg* %23, i32 0, i32 1, !dbg !218
  %258 = bitcast [1 x i8]* %257 to i1*, !dbg !218
  %259 = load i1, i1* %258, align 8, !dbg !218
  %260 = bitcast %TSiSg* %23 to i8*, !dbg !217
  call void @llvm.lifetime.end.p0i8(i64 9, i8* %260), !dbg !217
  br i1 %259, label %285, label %261, !dbg !217

; <label>:261:                                    ; preds = %246
  br label %262, !dbg !217

; <label>:262:                                    ; preds = %261
  %263 = phi i64 [ %256, %261 ], !dbg !212
  store i64 %263, i64* %i.debug58, align 8, !dbg !219
  %arrSum._value59 = getelementptr inbounds %TSi, %TSi* %arrSum, i32 0, i32 0, !dbg !220
  %264 = load i64, i64* %arrSum._value59, align 8, !dbg !220
  %265 = bitcast %TSi* %32 to i8*, !dbg !222
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %265), !dbg !222
  %266 = call swiftcc i64 @"$sSayxSicigSi_Tg5"(i64 %263, %Ts28__ContiguousArrayStorageBaseC* %44), !dbg !224
  %._value60 = getelementptr inbounds %TSi, %TSi* %32, i32 0, i32 0, !dbg !224
  store i64 %266, i64* %._value60, align 8, !dbg !224
  %._value61 = getelementptr inbounds %TSi, %TSi* %32, i32 0, i32 0, !dbg !224
  %267 = load i64, i64* %._value61, align 8, !dbg !224
  %268 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %264, i64 %267), !dbg !225
  %269 = extractvalue { i64, i1 } %268, 0, !dbg !225
  %270 = extractvalue { i64, i1 } %268, 1, !dbg !225
  br i1 %270, label %363, label %271, !dbg !225

; <label>:271:                                    ; preds = %262
  %272 = bitcast %TSi* %32 to i8*, !dbg !225
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %272), !dbg !225
  %arrSum._value62 = getelementptr inbounds %TSi, %TSi* %arrSum, i32 0, i32 0, !dbg !226
  store i64 %269, i64* %arrSum._value62, align 8, !dbg !226
  %arrMul._value63 = getelementptr inbounds %TSi, %TSi* %arrMul, i32 0, i32 0, !dbg !227
  %273 = load i64, i64* %arrMul._value63, align 8, !dbg !227
  %274 = bitcast [24 x i8]* %access-scratch64 to i8*, !dbg !228
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %274), !dbg !228
  ...
  %275 = load %Ts28__ContiguousArrayStorageBaseC*, %Ts28__ContiguousArrayStorageBaseC** getelementptr inbounds (%TSa, %TSa* @"$s9reduction9globalArrSaySiGvp", i32 0, i32 0, i32 0), align 8, !dbg !228
  %276 = bitcast %TSi* %33 to i8*, !dbg !222
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %276), !dbg !222
  %277 = call swiftcc i64 @"$sSayxSicigSi_Tg5"(i64 %263, %Ts28__ContiguousArrayStorageBaseC* %275), !dbg !228
  %._value65 = getelementptr inbounds %TSi, %TSi* %33, i32 0, i32 0, !dbg !228
  store i64 %277, i64* %._value65, align 8, !dbg !228
  %._value66 = getelementptr inbounds %TSi, %TSi* %33, i32 0, i32 0, !dbg !228
  %278 = load i64, i64* %._value66, align 8, !dbg !228
  call void @swift_endAccess([24 x i8]* %access-scratch64) #2, !dbg !228
  %279 = bitcast [24 x i8]* %access-scratch64 to i8*, !dbg !228
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %279), !dbg !228
  %280 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %273, i64 %278), !dbg !229
  %281 = extractvalue { i64, i1 } %280, 0, !dbg !229
  %282 = extractvalue { i64, i1 } %280, 1, !dbg !229
  br i1 %282, label %364, label %283, !dbg !229

; <label>:283:                                    ; preds = %271
  %284 = bitcast %TSi* %33 to i8*, !dbg !229
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %284), !dbg !229
  %arrMul._value67 = getelementptr inbounds %TSi, %TSi* %arrMul, i32 0, i32 0, !dbg !230
  store i64 %281, i64* %arrMul._value67, align 8, !dbg !230
  br label %246, !dbg !231

; <label>:285:                                    ; preds = %246
  %286 = bitcast %Ts16IndexingIteratorVySNySiGG* %"$i$generator25" to i8*, !dbg !156
  call void @llvm.lifetime.end.p0i8(i64 25, i8* %286), !dbg !156
  %287 = bitcast [24 x i8]* %access-scratch39 to i8*, !dbg !232
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %287), !dbg !232
  ...
  %288 = bitcast [24 x i8]* %access-scratch39 to i8*, !dbg !232
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %288), !dbg !232
  %a._value40 = getelementptr inbounds %TSi, %TSi* %a, i32 0, i32 0, !dbg !233
  store i64 0, i64* %a._value40, align 8, !dbg !233
  %289 = bitcast %Ts16IndexingIteratorVySNySiGG* %"$i$generator41" to i8*, !dbg !234
  call void @llvm.lifetime.start.p0i8(i64 25, i8* %289), !dbg !234
  %290 = bitcast %TSNySiG* %25 to i8*, !dbg !234
  call void @llvm.lifetime.start.p0i8(i64 16, i8* %290), !dbg !234
  br label %291, !dbg !236

; <label>:291:                                    ; preds = %285
  br label %292, !dbg !236

; <label>:292:                                    ; preds = %291
  %293 = bitcast %TSi* %26 to i8*, !dbg !234
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %293), !dbg !234
  %._value42 = getelementptr inbounds %TSi, %TSi* %26, i32 0, i32 0, !dbg !236
  store i64 0, i64* %._value42, align 8, !dbg !236
  %294 = bitcast %TSi* %27 to i8*, !dbg !234
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %294), !dbg !234
  ...
  %295 = load i64, i64* %._value44, align 8, !dbg !236
  %._value45 = getelementptr inbounds %TSi, %TSi* %27, i32 0, i32 0, !dbg !236
  %296 = load i64, i64* %._value45, align 8, !dbg !236
  %297 = call swiftcc { i64, i64 } @"$sSN15uncheckedBoundsSNyxGx5lower_x5uppert_tcfCSi_Tg5"(i64 %295, i64 %296), !dbg !236
  %298 = extractvalue { i64, i64 } %297, 0, !dbg !236
  %299 = extractvalue { i64, i64 } %297, 1, !dbg !236
  ...
  store i64 %298, i64* %.lowerBound46._value, align 8, !dbg !236
  ...
  store i64 %299, i64* %.upperBound47._value, align 8, !dbg !236
  %300 = bitcast %TSi* %27 to i8*, !dbg !236
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %300), !dbg !236
  %301 = bitcast %TSi* %26 to i8*, !dbg !236
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %301), !dbg !236
  ...
  %302 = load i64, i64* %.lowerBound48._value, align 8, !dbg !236
  ...
  %303 = load i64, i64* %.upperBound49._value, align 8, !dbg !236
  %304 = bitcast %TSNySiG* %28 to i8*, !dbg !234
  ...
  store i64 %302, i64* %.lowerBound50._value, align 8, !dbg !236
  ...
  store i64 %303, i64* %.upperBound51._value, align 8, !dbg !236
  ...
  %305 = load i64, i64* %.lowerBound52._value, align 8, !dbg !237
  ...
  %306 = load i64, i64* %.upperBound53._value, align 8, !dbg !237
  %307 = call swiftcc { i64, i64, i64, i8 } @"$sSlss16IndexingIteratorVyxG0B0RtzrlE04makeB0ACyFSNySiG_Tg5"(i64 %305, i64 %306), !dbg !237
  %308 = extractvalue { i64, i64, i64, i8 } %307, 0, !dbg !237
  %309 = extractvalue { i64, i64, i64, i8 } %307, 1, !dbg !237
  %310 = extractvalue { i64, i64, i64, i8 } %307, 2, !dbg !237
  %311 = extractvalue { i64, i64, i64, i8 } %307, 3, !dbg !237
  %312 = trunc i8 %311 to i1, !dbg !237
  ...
  store i64 %308, i64* %"$i$generator41._elements.lowerBound._value", align 8, !dbg !237
  ...
  store i64 %309, i64* %"$i$generator41._elements.upperBound._value", align 8, !dbg !237
  ...
  %313 = bitcast %TSNsSxRzSZ6StrideRpzrlE5IndexOySi_G* %"$i$generator41._position" to i64*, !dbg !237
  store i64 %310, i64* %313, align 8, !dbg !237
  %314 = getelementptr inbounds %TSNsSxRzSZ6StrideRpzrlE5IndexOySi_G, %TSNsSxRzSZ6StrideRpzrlE5IndexOySi_G* %"$i$generator41._position", i32 0, i32 1, !dbg !237
  %315 = bitcast [1 x i8]* %314 to i1*, !dbg !237
  store i1 %312, i1* %315, align 8, !dbg !237
  %316 = bitcast %TSNySiG* %28 to i8*, !dbg !238
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %316), !dbg !238
  %317 = bitcast %TSNySiG* %25 to i8*, !dbg !238
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %317), !dbg !238
  br label %318, !dbg !238

; <label>:318:                                    ; preds = %349, %292
  %319 = bitcast %TSiSg* %29 to i8*, !dbg !234
  call void @llvm.lifetime.start.p0i8(i64 9, i8* %319), !dbg !234
  %320 = call swiftcc { i64, i8 } @"$ss16IndexingIteratorV4next7ElementQzSgyFSNySiG_Tg5"(%Ts16IndexingIteratorVySNySiGG* nocapture swiftself dereferenceable(25) %"$i$generator41"), !dbg !239
  %321 = extractvalue { i64, i8 } %320, 0, !dbg !239
  %322 = extractvalue { i64, i8 } %320, 1, !dbg !239
  %323 = trunc i8 %322 to i1, !dbg !239
  %324 = bitcast %TSiSg* %29 to i64*, !dbg !239
  store i64 %321, i64* %324, align 8, !dbg !239
  %325 = getelementptr inbounds %TSiSg, %TSiSg* %29, i32 0, i32 1, !dbg !239
  %326 = bitcast [1 x i8]* %325 to i1*, !dbg !239
  store i1 %323, i1* %326, align 8, !dbg !239
  %327 = bitcast %TSiSg* %29 to i64*, !dbg !239
  %328 = load i64, i64* %327, align 8, !dbg !239
  %329 = getelementptr inbounds %TSiSg, %TSiSg* %29, i32 0, i32 1, !dbg !239
  %330 = bitcast [1 x i8]* %329 to i1*, !dbg !239
  %331 = load i1, i1* %330, align 8, !dbg !239
  %332 = bitcast %TSiSg* %29 to i8*, !dbg !238
  call void @llvm.lifetime.end.p0i8(i64 9, i8* %332), !dbg !238
  br i1 %331, label %352, label %333, !dbg !238

; <label>:333:                                    ; preds = %318
  br label %334, !dbg !238

; <label>:334:                                    ; preds = %333
  %335 = phi i64 [ %328, %333 ], !dbg !234
  store i64 %335, i64* %i.debug, align 8, !dbg !240
  %a._value54 = getelementptr inbounds %TSi, %TSi* %a, i32 0, i32 0, !dbg !241
  %336 = load i64, i64* %a._value54, align 8, !dbg !241
  %337 = call swiftcc i64 @"$s9reduction11expensiveOP1nS2i_tF"(i64 3), !dbg !243
  %338 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %336, i64 %337), !dbg !244
  %339 = extractvalue { i64, i1 } %338, 0, !dbg !244
  %340 = extractvalue { i64, i1 } %338, 1, !dbg !244
  br i1 %340, label %361, label %341, !dbg !244

; <label>:341:                                    ; preds = %334
  %a._value55 = getelementptr inbounds %TSi, %TSi* %a, i32 0, i32 0, !dbg !245
  store i64 %339, i64* %a._value55, align 8, !dbg !245
  %342 = bitcast [24 x i8]* %access-scratch56 to i8*, !dbg !246
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %342), !dbg !246
  call void @swift_beginAccess(i8* bitcast (%TSi* @"$s9reduction2cGSivp" to i8*), [24 x i8]* %access-scratch56, i64 32, i8* null) #2, !dbg !246
  %343 = load i64, i64* getelementptr inbounds (%TSi, %TSi* @"$s9reduction2cGSivp", i32 0, i32 0), align 8, !dbg !246
  call void @swift_endAccess([24 x i8]* %access-scratch56) #2, !dbg !246
  %344 = bitcast [24 x i8]* %access-scratch56 to i8*, !dbg !246
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %344), !dbg !246
  %345 = call swiftcc i64 @"$s9reduction11expensiveOP1nS2i_tF"(i64 3), !dbg !247
  %346 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %343, i64 %345), !dbg !248
  %347 = extractvalue { i64, i1 } %346, 0, !dbg !248
  %348 = extractvalue { i64, i1 } %346, 1, !dbg !248
  br i1 %348, label %362, label %349, !dbg !248

; <label>:349:                                    ; preds = %341
  %350 = bitcast [24 x i8]* %access-scratch57 to i8*, !dbg !249
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %350), !dbg !249
  call void @swift_beginAccess(i8* bitcast (%TSi* @"$s9reduction2cGSivp" to i8*), [24 x i8]* %access-scratch57, i64 33, i8* null) #2, !dbg !249
  store i64 %347, i64* getelementptr inbounds (%TSi, %TSi* @"$s9reduction2cGSivp", i32 0, i32 0), align 8, !dbg !249
  call void @swift_endAccess([24 x i8]* %access-scratch57) #2, !dbg !249
  %351 = bitcast [24 x i8]* %access-scratch57 to i8*, !dbg !249
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %351), !dbg !249
  br label %318, !dbg !250

; <label>:352:                                    ; preds = %318
  %353 = bitcast %Ts16IndexingIteratorVySNySiGG* %"$i$generator41" to i8*, !dbg !251
  call void @llvm.lifetime.end.p0i8(i64 25, i8* %353), !dbg !251
  %354 = bitcast %TSi* %arrMul to i8*, !dbg !251
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %354), !dbg !251
  %355 = bitcast %TSi* %arrSum to i8*, !dbg !251
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %355), !dbg !251
  %356 = call %TSa* @"$sSaySiGWOh"(%TSa* %localArr), !dbg !251
  %357 = bitcast %TSa* %localArr to i8*, !dbg !251
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %357), !dbg !251
  %358 = bitcast %TSi* %c to i8*, !dbg !251
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %358), !dbg !251
  %359 = bitcast %TSi* %b to i8*, !dbg !251
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %359), !dbg !251
  %360 = bitcast %TSi* %a to i8*, !dbg !251
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %360), !dbg !251
  ret void, !dbg !251
...
!4 = !DICompositeType(tag: DW_TAG_structure_type, name: "Int", scope: !6, file: !5, size: 64, elements: !7, runtimeLang: DW_LANG_Swift, identifier: "$sSiD")
...
!24 = !DICompositeType(tag: DW_TAG_structure_type, name: "Array", scope: !6, file: !3, size: 64, elements: !7, runtimeLang: DW_LANG_Swift, identifier: "$sSaySiGD")
...
!44 = !{!45, !45, !46}
!45 = !DICompositeType(tag: DW_TAG_structure_type, name: "Int32", scope: !6, file: !5, size: 32, elements: !7, runtimeLang: DW_LANG_Swift, identifier: "$ss5Int32VD")
!46 = !DICompositeType(tag: DW_TAG_structure_type, name: "UnsafeMutablePointer", scope: !6, file: !3, size: 64, elements: !7, runtimeLang: DW_LANG_Swift, identifier: "$sSpySpys4Int8VGSgGD")
...
!129 = !{!130}
!130 = !DICompositeType(tag: DW_TAG_structure_type, name: "$sytD", file: !3, elements: !7, runtimeLang: DW_LANG_Swift, identifier: "$sytD")
