...
@panic_loc.3 = private unnamed_addr constant { { [0 x i8]*, i64 }, { [0 x i8]*, i64 }, i32, i32 } { { [0 x i8]*, i64 } { [0 x i8]* bitcast ([28 x i8]* @str.2 to [0 x i8]*), i64 28 }, { [0 x i8]*, i64 } { [0 x i8]* bitcast ([12 x i8]* @str.1 to [0 x i8]*), i64 12 }, i32 9, i32 13 }, align 8
@str.4 = internal constant [33 x i8] c"attempt to subtract with overflow"
@panic_loc.5 = private unnamed_addr constant { { [0 x i8]*, i64 }, { [0 x i8]*, i64 }, i32, i32 } { { [0 x i8]*, i64 } { [0 x i8]* bitcast ([33 x i8]* @str.4 to [0 x i8]*), i64 33 }, { [0 x i8]*, i64 } { [0 x i8]* bitcast ([12 x i8]* @str.1 to [0 x i8]*), i64 12 }, i32 10, i32 13 }, align 8
@panic_bounds_check_loc.6 = private unnamed_addr constant { { [0 x i8]*, i64 }, i32, i32 } { { [0 x i8]*, i64 } { [0 x i8]* bitcast ([12 x i8]* @str.1 to [0 x i8]*), i64 12 }, i32 11, i32 17 }, align 8
@panic_loc.7 = private unnamed_addr constant { { [0 x i8]*, i64 }, { [0 x i8]*, i64 }, i32, i32 } { { [0 x i8]*, i64 } { [0 x i8]* bitcast ([28 x i8]* @str.2 to [0 x i8]*), i64 28 }, { [0 x i8]*, i64 } { [0 x i8]* bitcast ([12 x i8]* @str.1 to [0 x i8]*), i64 12 }, i32 11, i32 13 }, align 8
@panic_bounds_check_loc.8 = private unnamed_addr constant { { [0 x i8]*, i64 }, i32, i32 } { { [0 x i8]*, i64 } { [0 x i8]* bitcast ([12 x i8]* @str.1 to [0 x i8]*), i64 12 }, i32 12, i32 17 }, align 8
@str.9 = internal constant [33 x i8] c"attempt to multiply with overflow"
@panic_loc.a = private unnamed_addr constant { { [0 x i8]*, i64 }, { [0 x i8]*, i64 }, i32, i32 } { { [0 x i8]*, i64 } { [0 x i8]* bitcast ([33 x i8]* @str.9 to [0 x i8]*), i64 33 }, { [0 x i8]*, i64 } { [0 x i8]* bitcast ([12 x i8]* @str.1 to [0 x i8]*), i64 12 }, i32 12, i32 13 }, align 8
...
start:
  ...
  call void @llvm.dbg.declare(metadata i32* %d, metadata !562, metadata !DIExpression()), !dbg !564
  call void @llvm.dbg.declare(metadata [5 x i32]* %arr, metadata !565, metadata !DIExpression()), !dbg !570
  call void @llvm.dbg.declare(metadata {}* %_result, metadata !571, metadata !DIExpression()), !dbg !573
  call void @llvm.dbg.declare(metadata { i64, i64 }* %iter, metadata !574, metadata !DIExpression()), !dbg !576
  call void @llvm.dbg.declare(metadata i64* %__next, metadata !577, metadata !DIExpression()), !dbg !579
  call void @llvm.dbg.declare(metadata i64* %val, metadata !580, metadata !DIExpression()), !dbg !582
  call void @llvm.dbg.declare(metadata i64* %i, metadata !583, metadata !DIExpression()), !dbg !585
  store i32 0, i32* %a, align 4, !dbg !586
  store i32 0, i32* %b, align 4, !dbg !587
  store i32 0, i32* %c, align 4, !dbg !588
  store i32 0, i32* %d, align 4, !dbg !589
  %0 = bitcast [5 x i32]* %arr to i32*, !dbg !590
  store i32 1, i32* %0, align 4, !dbg !590
  %1 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i32 0, i32 1, !dbg !590
  store i32 2, i32* %1, align 4, !dbg !590
  %2 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i32 0, i32 2, !dbg !590
  store i32 3, i32* %2, align 4, !dbg !590
  %3 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i32 0, i32 3, !dbg !590
  store i32 4, i32* %3, align 4, !dbg !590
  %4 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i32 0, i32 4, !dbg !590
  store i32 5, i32* %4, align 4, !dbg !590
  %5 = bitcast [5 x i32]* %arr to [0 x i32]*, !dbg !591
; call core::slice::<impl [T]>::len
  %6 = call i64 @"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$3len17hf9886a316153c6d6E"([0 x i32]* noalias nonnull readonly %5, i64 5), !dbg !591
  br label %bb1, !dbg !591

bb1:                                              ; preds = %start
  %7 = bitcast { i64, i64 }* %_8 to i64*, !dbg !592
  store i64 0, i64* %7, align 8, !dbg !592
  %8 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %_8, i32 0, i32 1, !dbg !592
  store i64 %6, i64* %8, align 8, !dbg !592
  %9 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %_8, i32 0, i32 0, !dbg !592
  %10 = load i64, i64* %9, align 8, !dbg !592
  %11 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %_8, i32 0, i32 1, !dbg !592
  %12 = load i64, i64* %11, align 8, !dbg !592
; call <I as core::iter::traits::IntoIterator>::into_iter
  %13 = call { i64, i64 } @"_ZN54_$LT$I$u20$as$u20$core..iter..traits..IntoIterator$GT$9into_iter17h4c4314c22fcf64f6E"(i64 %10, i64 %12), !dbg !592
  store { i64, i64 } %13, { i64, i64 }* %_7, align 8, !dbg !592
  br label %bb2, !dbg !592

bb2:                                              ; preds = %bb1
  %14 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %_7, i32 0, i32 0, !dbg !592
  %15 = load i64, i64* %14, align 8, !dbg !592
  %16 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %_7, i32 0, i32 1, !dbg !592
  %17 = load i64, i64* %16, align 8, !dbg !592
  %18 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %iter, i32 0, i32 0, !dbg !592
  store i64 %15, i64* %18, align 8, !dbg !592
  %19 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %iter, i32 0, i32 1, !dbg !592
  store i64 %17, i64* %19, align 8, !dbg !592
  br label %bb3, !dbg !592

bb3:                                              ; preds = %bb13, %bb2
; call core::iter::range::<impl core::iter::iterator::Iterator for core::ops::range::Range<A>>::next
  %20 = call { i64, i64 } @"_ZN4core4iter5range93_$LT$impl$u20$core..iter..iterator..Iterator$u20$for$u20$core..ops..range..Range$LT$A$GT$$GT$4next17h08af673f70db9933E"({ i64, i64 }* dereferenceable(16) %iter), !dbg !579
  store { i64, i64 } %20, { i64, i64 }* %_15, align 8, !dbg !579
  br label %bb4, !dbg !579

bb4:                                              ; preds = %bb3
  %21 = bitcast { i64, i64 }* %_15 to i64*, !dbg !579
  %22 = load i64, i64* %21, align 8, !dbg !579, !range !200
  %23 = bitcast { i64, i64 }* %_15 to i64*, !dbg !593
  %24 = load i64, i64* %23, align 8, !dbg !593, !range !200
...
bb7:                                              ; preds = %bb4
  %25 = bitcast { i64, i64 }* %_15 to %"core::option::Option<usize>::Some"*, !dbg !593
  %26 = getelementptr inbounds %"core::option::Option<usize>::Some", %"core::option::Option<usize>::Some"* %25, i32 0, i32 1, !dbg !593
  %27 = load i64, i64* %26, align 8, !dbg !593
  store i64 %27, i64* %val, align 8, !dbg !593
  %28 = load i64, i64* %val, align 8, !dbg !582
  store i64 %28, i64* %__next, align 8, !dbg !582
  %29 = load i64, i64* %__next, align 8, !dbg !579
  store i64 %29, i64* %i, align 8, !dbg !579
  %30 = load i32, i32* %a, align 4, !dbg !595
  %31 = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 %30, i32 1), !dbg !595
  %32 = extractvalue { i32, i1 } %31, 0, !dbg !595
  %33 = extractvalue { i32, i1 } %31, 1, !dbg !595
  %34 = call i1 @llvm.expect.i1(i1 %33, i1 false), !dbg !595
  br i1 %34, label %panic, label %bb8, !dbg !595

bb8:                                              ; preds = %bb7
  store i32 %32, i32* %a, align 4, !dbg !596
  %35 = load i32, i32* %b, align 4, !dbg !597
  %36 = call { i32, i1 } @llvm.ssub.with.overflow.i32(i32 %35, i32 5), !dbg !597
  %37 = extractvalue { i32, i1 } %36, 0, !dbg !597
  %38 = extractvalue { i32, i1 } %36, 1, !dbg !597
  %39 = call i1 @llvm.expect.i1(i1 %38, i1 false), !dbg !597
  br i1 %39, label %panic1, label %bb9, !dbg !597

bb9:                                              ; preds = %bb8
  store i32 %37, i32* %b, align 4, !dbg !598
  %40 = load i32, i32* %c, align 4, !dbg !599
  %41 = load i64, i64* %i, align 8, !dbg !600
  %42 = icmp ult i64 %41, 5, !dbg !601
  %43 = call i1 @llvm.expect.i1(i1 %42, i1 true), !dbg !601
  br i1 %43, label %bb10, label %panic2, !dbg !601

bb10:                                             ; preds = %bb9
  %44 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i64 0, i64 %41, !dbg !601
  %45 = load i32, i32* %44, align 4, !dbg !601
  %46 = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 %40, i32 %45), !dbg !599
  %47 = extractvalue { i32, i1 } %46, 0, !dbg !599
  %48 = extractvalue { i32, i1 } %46, 1, !dbg !599
  %49 = call i1 @llvm.expect.i1(i1 %48, i1 false), !dbg !599
  br i1 %49, label %panic3, label %bb11, !dbg !599

bb11:                                             ; preds = %bb10
  store i32 %47, i32* %c, align 4, !dbg !602
  %50 = load i32, i32* %d, align 4, !dbg !603
  %51 = load i64, i64* %i, align 8, !dbg !604
  %52 = icmp ult i64 %51, 5, !dbg !605
  %53 = call i1 @llvm.expect.i1(i1 %52, i1 true), !dbg !605
  br i1 %53, label %bb12, label %panic4, !dbg !605

bb12:                                             ; preds = %bb11
  %54 = getelementptr inbounds [5 x i32], [5 x i32]* %arr, i64 0, i64 %51, !dbg !605
  %55 = load i32, i32* %54, align 4, !dbg !605
  %56 = call { i32, i1 } @llvm.smul.with.overflow.i32(i32 %50, i32 %55), !dbg !603
  %57 = extractvalue { i32, i1 } %56, 0, !dbg !603
  %58 = extractvalue { i32, i1 } %56, 1, !dbg !603
  %59 = call i1 @llvm.expect.i1(i1 %58, i1 false), !dbg !603
  br i1 %59, label %panic5, label %bb13, !dbg !603

bb13:                                             ; preds = %bb12
  store i32 %57, i32* %d, align 4, !dbg !606
...
; call core::panicking::panic_bounds_check
  call void @_ZN4core9panicking18panic_bounds_check17h8e752fa77de3cffeE({ [0 x i64], { [0 x i8]*, i64 }, [0 x i32], i32, [0 x i32], i32, [0 x i32] }* noalias readonly dereferenceable(24) bitcast ({ { [0 x i8]*, i64 }, i32, i32 }* @panic_bounds_check_loc.6 to { [0 x i64], { [0 x i8]*, i64 }, [0 x i32], i32, [0 x i32], i32, [0 x i32] }*), i64 %41, i64 5), !dbg !601
  unreachable, !dbg !601

panic3:                                           ; preds = %bb10
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17haa57ffd51eb03b56E({ [0 x i64], { [0 x i8]*, i64 }, [0 x i64], { [0 x i8]*, i64 }, [0 x i32], i32, [0 x i32], i32, [0 x i32] }* noalias readonly dereferenceable(40) bitcast ({ { [0 x i8]*, i64 }, { [0 x i8]*, i64 }, i32, i32 }* @panic_loc.7 to { [0 x i64], { [0 x i8]*, i64 }, [0 x i64], { [0 x i8]*, i64 }, [0 x i32], i32, [0 x i32], i32, [0 x i32] }*)), !dbg !599
  unreachable, !dbg !599

panic4:                                           ; preds = %bb11
; call core::panicking::panic_bounds_check
  call void @_ZN4core9panicking18panic_bounds_check17h8e752fa77de3cffeE({ [0 x i64], { [0 x i8]*, i64 }, [0 x i32], i32, [0 x i32], i32, [0 x i32] }* noalias readonly dereferenceable(24) bitcast ({ { [0 x i8]*, i64 }, i32, i32 }* @panic_bounds_check_loc.8 to { [0 x i64], { [0 x i8]*, i64 }, [0 x i32], i32, [0 x i32], i32, [0 x i32] }*), i64 %51, i64 5), !dbg !605
  unreachable, !dbg !605

panic5:                                           ; preds = %bb12
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17haa57ffd51eb03b56E({ [0 x i64], { [0 x i8]*, i64 }, [0 x i64], { [0 x i8]*, i64 }, [0 x i32], i32, [0 x i32], i32, [0 x i32] }* noalias readonly dereferenceable(40) bitcast ({ { [0 x i8]*, i64 }, { [0 x i8]*, i64 }, i32, i32 }* @panic_loc.a to { [0 x i64], { [0 x i8]*, i64 }, [0 x i64], { [0 x i8]*, i64 }, [0 x i32], i32, [0 x i32], i32, [0 x i32] }*)), !dbg !603
  unreachable, !dbg !603
}
...
!14 = !DIFile(filename: "reduction.rs", directory: "/home/simonschmalfuss/discopop/rust/CU_comp/reduction_with_array")
!15 = !{!16}
...
!553 = !DILocalVariable(name: "a", scope: !554, file: !14, line: 3, type: !52, align: 4)
!554 = distinct !DILexicalBlock(scope: !551, file: !14, line: 3, column: 4)
!555 = !DILocation(line: 3, column: 8, scope: !554)
!556 = !DILocalVariable(name: "b", scope: !557, file: !14, line: 4, type: !52, align: 4)
!557 = distinct !DILexicalBlock(scope: !554, file: !14, line: 4, column: 4)
!558 = !DILocation(line: 4, column: 8, scope: !557)
!559 = !DILocalVariable(name: "c", scope: !560, file: !14, line: 5, type: !52, align: 4)
!560 = distinct !DILexicalBlock(scope: !557, file: !14, line: 5, column: 4)
!561 = !DILocation(line: 5, column: 8, scope: !560)
!562 = !DILocalVariable(name: "d", scope: !563, file: !14, line: 6, type: !52, align: 4)
!563 = distinct !DILexicalBlock(scope: !560, file: !14, line: 6, column: 4)
!564 = !DILocation(line: 6, column: 8, scope: !563)
!565 = !DILocalVariable(name: "arr", scope: !566, file: !14, line: 7, type: !567, align: 4)
!566 = distinct !DILexicalBlock(scope: !563, file: !14, line: 7, column: 4)
!567 = !DICompositeType(tag: DW_TAG_array_type, baseType: !52, size: 160, align: 32, elements: !568)
!568 = !{!569}
!569 = !DISubrange(count: 5)
!570 = !DILocation(line: 7, column: 8, scope: !566)
!571 = !DILocalVariable(name: "_result", scope: !572, file: !14, line: 8, type: !36, align: 1)
!572 = distinct !DILexicalBlock(scope: !566, file: !14, line: 8, column: 4)
!573 = !DILocation(line: 8, column: 4, scope: !572)
!574 = !DILocalVariable(name: "iter", scope: !575, file: !14, line: 8, type: !443, align: 8)
!575 = distinct !DILexicalBlock(scope: !566, file: !14, line: 8, column: 4)
!576 = !DILocation(line: 8, column: 13, scope: !575)
!577 = !DILocalVariable(name: "__next", scope: !578, file: !14, line: 8, type: !92, align: 8)
!578 = distinct !DILexicalBlock(scope: !575, file: !14, line: 8, column: 13)
!579 = !DILocation(line: 8, column: 13, scope: !578)
!580 = !DILocalVariable(name: "val", scope: !581, file: !14, line: 8, type: !92, align: 8)
!581 = distinct !DILexicalBlock(scope: !578, file: !14, line: 8, column: 8)
!582 = !DILocation(line: 8, column: 8, scope: !581)
!583 = !DILocalVariable(name: "i", scope: !584, file: !14, line: 8, type: !92, align: 8)
!584 = distinct !DILexicalBlock(scope: !578, file: !14, line: 8, column: 13)
!585 = !DILocation(line: 8, column: 8, scope: !584)
!586 = !DILocation(line: 3, column: 20, scope: !551)
!587 = !DILocation(line: 4, column: 20, scope: !554)
!588 = !DILocation(line: 5, column: 20, scope: !557)
!589 = !DILocation(line: 6, column: 20, scope: !560)
!590 = !DILocation(line: 7, column: 28, scope: !563)
!591 = !DILocation(line: 8, column: 16, scope: !566)
!592 = !DILocation(line: 8, column: 13, scope: !566)
!593 = !DILocation(line: 8, column: 8, scope: !578)
!594 = !DILocation(line: 15, column: 1, scope: !551)
!595 = !DILocation(line: 9, column: 12, scope: !584)
!596 = !DILocation(line: 9, column: 8, scope: !584)
!597 = !DILocation(line: 10, column: 12, scope: !584)
!598 = !DILocation(line: 10, column: 8, scope: !584)
!599 = !DILocation(line: 11, column: 12, scope: !584)
!600 = !DILocation(line: 11, column: 20, scope: !584)
!601 = !DILocation(line: 11, column: 16, scope: !584)
!602 = !DILocation(line: 11, column: 8, scope: !584)
!603 = !DILocation(line: 12, column: 12, scope: !584)
!604 = !DILocation(line: 12, column: 20, scope: !584)
!605 = !DILocation(line: 12, column: 16, scope: !584)
!606 = !DILocation(line: 12, column: 8, scope: !584)
!607 = !DILocation(line: 8, column: 4, scope: !575)
