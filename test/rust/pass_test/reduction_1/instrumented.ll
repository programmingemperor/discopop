...
define hidden i64 @_ZN3std2rt10lang_start17h447b166fa1bbfa61E(void ()* nonnull %0, i64 %1, i8** %2) unnamed_addr #0 !dbg !24 {
start:
...
; Function Attrs: uwtable
define internal i32 @"_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17hfa3a1cd97b285fe9E"(i8** noalias readonly dereferenceable(8) %0) unnamed_addr #0 !dbg !48 {
start:
...
define internal i32 @_ZN3std3sys4unix7process14process_common8ExitCode6as_i3217h45f1cf928f91d05aE(i8* noalias readonly dereferenceable(1) %0) unnamed_addr #1 !dbg !58 {
start:
...
; Function Attrs: inlinehint uwtable
define internal { i64, i64 } @"_ZN49_$LT$usize$u20$as$u20$core..iter..range..Step$GT$9add_usize17hf2433d5fe01eed32E"(i64* noalias readonly dereferenceable(8) %0, i64 %1) unnamed_addr #1 !dbg !74 {
start:
...
; Function Attrs: inlinehint uwtable
define internal zeroext i1 @"_ZN4core3cmp5impls57_$LT$impl$u20$core..cmp..PartialOrd$u20$for$u20$usize$GT$2lt17hb4203fcb62247c1dE"(i64* noalias readonly dereferenceable(8) %0, i64* noalias readonly dereferenceable(8) %1) unnamed_addr #1 !dbg !106 {
start:
...
; Function Attrs: inlinehint uwtable
define internal void @_ZN4core3mem13uninitialized17h312375f473e659e1E(<4 x i64>* noalias nocapture sret(<4 x i64>) dereferenceable(32) %0) unnamed_addr #1 !dbg !120 {
start:
...
; Function Attrs: inlinehint uwtable
define internal void @_ZN4core3mem13uninitialized17h5353db0349229fa3E(%"core::ptr::swap_nonoverlapping_bytes::UnalignedBlock"* noalias nocapture sret(%"core::ptr::swap_nonoverlapping_bytes::UnalignedBlock") dereferenceable(32) %0) unnamed_addr #1 !dbg !137 {
start:
...
; Function Attrs: inlinehint uwtable
define internal void @_ZN4core3mem4swap17h6ba622a47cf96402E(i64* dereferenceable(8) %0, i64* dereferenceable(8) %1) unnamed_addr #1 !dbg !157 {
start:
...
; Function Attrs: inlinehint uwtable
define internal { i64, i64 } @"_ZN4core3num23_$LT$impl$u20$usize$GT$11checked_add17h594d6300cb62e4bcE"(i64 %0, i64 %1) unnamed_addr #1 !dbg !175 {
start:
  %b = alloca i8, align 1
...
; Function Attrs: inlinehint uwtable
define internal { i64, i8 } @"_ZN4core3num23_$LT$impl$u20$usize$GT$15overflowing_add17h7ab30bfe5b2e7d93E"(i64 %0, i64 %1) unnamed_addr #1 !dbg !201 {
start:
...
; Function Attrs: uwtable
define internal i32 @_ZN4core3ops8function6FnOnce9call_once17h3ac55c54819e6932E(i8* nonnull %0) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception"*, %"unwind::libunwind::_Unwind_Context"*)* @rust_eh_personality !dbg !226 {
start:
...
; Function Attrs: uwtable
define internal void @_ZN4core3ptr13drop_in_place17hcdf5f187d0cf4982E(i8** %0) unnamed_addr #0 !dbg !240 {
start:
  %arg0 = alloca i8**, align 8
  store i8** %0, i8*** %arg0, align 8
...
; Function Attrs: inlinehint uwtable
define internal void @_ZN4core3ptr19swap_nonoverlapping17h8e8f08e906c887d6E(i64* %0, i64* %1, i64 %2) unnamed_addr #1 !dbg !250 {
start:
...
; Function Attrs: inlinehint uwtable
define internal void @_ZN4core3ptr23swap_nonoverlapping_one17h5b2d88b0fc8c9977E(i64* %0, i64* %1) unnamed_addr #1 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception"*, %"unwind::libunwind::_Unwind_Context"*)* @rust_eh_personality !dbg !277 {
start:
  %personalityslot = alloca { i8*, i32 }, align 8
...
; Function Attrs: inlinehint uwtable
define internal void @_ZN4core3ptr25swap_nonoverlapping_bytes17hb4f23dd709ecb651E(i8* %0, i8* %1, i64 %2) unnamed_addr #1 !dbg !302 {
start:
...
bb4:                                              ; preds = %bb2
  call void @_ZN4core3mem13uninitialized17h312375f473e659e1E(<4 x i64>* noalias nocapture sret(<4 x i64>) dereferenceable(32) %t), !dbg !351
...
bb11:                                             ; preds = %bb3
  call void @_ZN4core3mem13uninitialized17h5353db0349229fa3E(%"core::ptr::swap_nonoverlapping_bytes::UnalignedBlock"* noalias nocapture sret(%"core::ptr::swap_nonoverlapping_bytes::UnalignedBlock") dereferenceable(32) %t4), !dbg !371
...
; Function Attrs: inlinehint uwtable
define internal i8* @"_ZN4core3ptr31_$LT$impl$u20$$BP$mut$u20$T$GT$3add17h2fa52a3c6a67619aE"(i8* %0, i64 %1) unnamed_addr #1 !dbg !392 {
start:
  %count = alloca i64, align 8
  %self = alloca i8*, align 8
  store i8* %0, i8** %self, align 8
...
; Function Attrs: inlinehint uwtable
define internal i8* @"_ZN4core3ptr31_$LT$impl$u20$$BP$mut$u20$T$GT$6offset17h81c7627fe4120de0E"(i8* %0, i64 %1) unnamed_addr #1 !dbg !404 {
start:
...
; Function Attrs: inlinehint uwtable
define internal i64 @_ZN4core3ptr4read17h3e115e2ff3af3ee9E(i64* %0) unnamed_addr #1 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception"*, %"unwind::libunwind::_Unwind_Context"*)* @rust_eh_personality !dbg !414 {
start:
  %personalityslot = alloca { i8*, i32 }, align 8
...
; Function Attrs: inlinehint uwtable
define internal void @_ZN4core3ptr5write17h5d47e28fbefe910aE(i64* %0, i64 %1) unnamed_addr #1 !dbg !430 {
start:
  %src = alloca i64, align 8
...
; Function Attrs: inlinehint uwtable
define internal i64 @"_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$3len17hf9886a316153c6d6E"([0 x i32]* noalias nonnull readonly %0, i64 %1) unnamed_addr #1 !dbg !472 {
start:
...
; Function Attrs: uwtable
define internal i64 @"_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17h2980c1cda476e7c8E"(i64 %0) unnamed_addr #0 !dbg !491 {
start:
...
; Function Attrs: uwtable
define internal i64 @"_ZN53_$LT$T$u20$as$u20$core..convert..TryFrom$LT$U$GT$$GT$8try_from17h2cc47ee77e12255cE"(i64 %0) unnamed_addr #0 !dbg !501 {
start:
...
; Function Attrs: uwtable
define internal { i64, i64 } @"_ZN54_$LT$I$u20$as$u20$core..iter..traits..IntoIterator$GT$9into_iter17h4c4314c22fcf64f6E"(i64 %0, i64 %1) unnamed_addr #0 !dbg !529 {
start:
  %self = alloca { i64, i64 }, align 8
...
; Function Attrs: inlinehint uwtable
define internal i32 @"_ZN68_$LT$std..process..ExitCode$u20$as$u20$std..process..Termination$GT$6report17h2c6dfc893d38975eE"(i8 %0) unnamed_addr #1 !dbg !541 {
start:
...
!551 = distinct !DISubprogram(name: "main", linkageName: "_ZN9reduction4main17h7e25980b9ee16ef8E", scope: !552, file: !14, line: 1, type: !9, scopeLine: 1, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagMainSubprogram, unit: !13, templateParams: !4, retainedNodes: !4)
...
!565 = !{!566}
!566 = !DISubrange(count: 5, lowerBound: 0)
